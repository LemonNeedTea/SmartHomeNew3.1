...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ModeAirseasonsonTimerPageModule", function() { return ModeAirseasonsonTimerPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mode_airseasonson_timer__ = __webpack_require__(903);
...
var ModeAirseasonsonTimerPageModule = (function () {
    function ModeAirseasonsonTimerPageModule() {
    }
    ModeAirseasonsonTimerPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__mode_airseasonson_timer__["a" /* ModeAirseasonsonTimerPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__mode_airseasonson_timer__["a" /* ModeAirseasonsonTimerPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], ModeAirseasonsonTimerPageModule);
    return ModeAirseasonsonTimerPageModule;
}());

//# sourceMappingURL=mode-airseasonson-timer.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ModeAirseasonsonTimerPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
 ...
 */
var ModeAirseasonsonTimerPage = (function () {
    function ModeAirseasonsonTimerPage(navCtrl, navParams, viewCtrl, tools) {
    ...
    ModeAirseasonsonTimerPage.prototype.ionViewDidLoad = function () {
    };
    ModeAirseasonsonTimerPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    ModeAirseasonsonTimerPage.prototype.complate = function () {
    ...
    ModeAirseasonsonTimerPage.prototype.getParams = function () {
        var params = new __WEBPACK_IMPORTED_MODULE_4__providers_model_model__["i" /* SeasonModeParams */](); //注意组装顺序
        params.loop = this.loop;
        return params;
    };
    ModeAirseasonsonTimerPage.prototype.checkParam = function () {
        return true;
    };
    ModeAirseasonsonTimerPage.prototype.getData = function () {
    ...
    ModeAirseasonsonTimerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-mode-airseasonson-timer',template:/*ion-inline-start:"/Users/zhoubo/Project/SmartHomeNew3.1/src/pages/timer/mode-airseasonson-timer/mode-airseasonson-timer.html"*/'<!--\n  Generated template for the ModeAirseasonsonTimerPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>定时</ion-title>\n    <ion-buttons start>\n      <button ion-button (click)="dismiss()">\n        <ion-icon ios="md-close" md="md-close"></ion-icon>\n      </button>\n\n    </ion-buttons>\n    <ion-buttons end>\n      <button ion-button (click)="complate()">\n        <ion-icon ios="md-checkmark" md="md-checkmark"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content class="setting-page">\n  <ion-list>\n    <my-loop name=\'开启时间\' [(myModel)]="loop" name=\'月份\' type=\'month\' isTrans=\'0\'></my-loop>\n\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"/Users/zhoubo/Project/SmartHomeNew3.1/src/pages/timer/mode-airseasonson-timer/mode-airseasonson-timer.html"*/,
        }),
    ...
    return ModeAirseasonsonTimerPage;
}());

//# sourceMappingURL=mode-airseasonson-timer.js.map
