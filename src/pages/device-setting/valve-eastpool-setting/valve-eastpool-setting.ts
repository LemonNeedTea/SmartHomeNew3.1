...
@IonicPage()
@Component({
  selector: 'page-valve-eastpool-setting',
  templateUrl: 'valve-eastpool-setting.html',
})
export class ValveEastpoolSettingPage {
  name: string;
  id: string;
  state: boolean;
  auto: boolean;
  ...
  presentShowModal() {
    let profileModal = this.modalCtrl.create('ValveEastpoolTimerPage');
